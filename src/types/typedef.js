...
class DocumentedTypeDef extends DocumentedItem {
	...
	serializer() {
		return {
			...
			props: this.directData.properties ? this.directData.properties.map((param) => param.serialize()) : undefined,
			params: this.directData.params ? this.directData.params.map((param) => param.serialize()) : undefined,
